...
<body id="page-top">
    <div id="wrapper"style="background-image: url('assets/img/lavandera.jpg'); background-size: cover; background-position: center;"
    >
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0 toggled toggled" style="background: var(--bs-primary-text-emphasis);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3"><span><br><br><br><br>Lavandera<br>Laundry<br>Mangement<br>System</span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper"style="background-image: url('assets/img/lavandera.jpg'); background-size: cover; background-position: center;"
        >
            <div id="content"style="background-image: url('assets/img/lavandera.jpg'); background-size: cover; background-position: center;"
            >
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top"style="background-image: url('assets/img/header.jpg'); background-size: cover; background-position: center;">
                    ...
                    <div class="container">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-5"style="background-image: url('assets/img/lavandera.jpg'); background-size: cover; background-position: center;"
                                >
            ...
            <footer class="bg-white sticky-footer"style="background-image: url('assets/img/header.jpg'); background-size: cover; background-position: center;"
            >
