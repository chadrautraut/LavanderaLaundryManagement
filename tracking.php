...
<body style="background-color: #4e73df;">
                        ...
                        <div class="card-body p-5">
                            ...
                            foreach ($result as $row) {
                                ...
                                if ($status == 0) {
                                    ...
                                    $status = 100;
                                    // Show the rating modal when the order is completed
                                    echo "<script>setTimeout(function() { $('#ratingModal').modal('show'); }, 1000);</script>";
                                }    
                            ...
                            <?php
                                ...
                                echo "<p>Queue Number: $queue_number</p>";
                                echo "<p>Created At: $date0</p>";
    ...
    $.ajax({
        type: 'POST',
        url: 'submit_rating.php', // The PHP script that will handle the database insertion
        data: {
            rating: rating,
            comments: comments,
            transaction_id: '<?= $id ?>' // Pass the transaction ID if needed
        },
        ...
        error: function(xhr, status, error) {
            ...
            // Here you would typically send the rating to your server via AJAX
